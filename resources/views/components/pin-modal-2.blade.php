  ...
  <div class="bg-white rounded-xl shadow-lg p-8 w-96 max-w-[90%]">
    ...
    <div class="grid grid-cols-3 gap-3 mb-6">
      ...
      <button type="button" 
              ...
              onclick="clearProductPin()">
              C
      </button>
      <button type="button" 
              class="product-pin-btn h-14 bg-blue-50 rounded-lg text-xl font-bold text-blue-600 hover:bg-blue-100 transition-colors" 
              data-val="0">
              0
      </button>
      <button type="button" 
              class="h-14 bg-yellow-50 rounded-lg text-xl font-bold text-yellow-600 hover:bg-yellow-100 transition-colors" 
              onclick="deleteProductPin()">
              ⌫
      </button>
    </div>
