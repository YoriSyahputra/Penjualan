...
<div class="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8"
        ...
        <div class="max-w-md w-full space-y-8 bg-white p-4 sm:p-6 lg:p-8 rounded-2xl shadow-2xl"
            ...
            <!-- Reset Password Form -->
            <form class="mt-8 space-y-4 sm:space-y-6" method="POST" action="{{ route('password.email') }}">
                @csrf
                ...
                <div class="text-center">
                    <a href="{{ route('login') }}" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors duration-200 text-sm">
                        Back to Login
                    </a>
                </div>
            </form>
